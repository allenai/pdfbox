...
public class TestRubberStampWithImage extends TestCase
{
    ...
    {
        String documentFile = "src/test/resources/org/allenai/pdfbox/examples/pdmodel/document.pdf";
        String stampFile = "src/test/resources/org/allenai/pdfbox/examples/pdmodel/stamp.jpg";
