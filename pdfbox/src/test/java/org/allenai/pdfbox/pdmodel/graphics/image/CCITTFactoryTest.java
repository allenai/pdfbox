 ...
 */
package org.allenai.pdfbox.pdmodel.graphics.image;
...
import org.allenai.pdfbox.pdmodel.PDPageContentStream;


import static org.allenai.pdfbox.pdmodel.graphics.image.ValidateXImage.checkIdent;
import static org.allenai.pdfbox.pdmodel.graphics.image.ValidateXImage.validate;
...
public class CCITTFactoryTest extends TestCase
{
    ...
    {
        String tiffG3Path = "src/test/resources/org/allenai/pdfbox/pdmodel/graphics/image/ccittg3.tif";
        String tiffG4Path = "src/test/resources/org/allenai/pdfbox/pdmodel/graphics/image/ccittg4.tif";
    ...
    {
        String tiffPath = "src/test/resources/org/allenai/pdfbox/pdmodel/graphics/image/ccittg4multi.tif";
