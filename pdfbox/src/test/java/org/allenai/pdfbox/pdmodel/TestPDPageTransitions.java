...
import org.allenai.pdfbox.pdmodel.interactive.pagenavigation.PDTransitionDirection;
import org.allenai.pdfbox.pdmodel.interactive.pagenavigation.PDTransitionStyle;
...
public class TestPDPageTransitions
{
    ...
    public void readTransitions() throws IOException
    {
        PDDocument doc = PDDocument.load(this.getClass().getResourceAsStream(
          "/org/allenai/pdfbox/pdmodel/interactive/pagenavigation/transitions_test.pdf"));
        ...
        Assert.assertEquals(PDTransitionDirection.TOP_LEFT_TO_BOTTOM_RIGHT.getCOSBase(),
