...
public class TestFields extends TestCase
{
    ...
    private static final String PATH_OF_PDF = "src/test/resources/org/allenai/pdfbox/pdmodel/interactive/form/AcroFormsBasicFields.pdf";
    ...
    public void testAcroFormsBasicFields() throws IOException
    {
        ...
        try
        {
            ...
            assertNotNull(textField);
            TestCase.assertEquals(textField.getCOSObject().getDictionaryObject(
                COSName.V).getClass().getSimpleName(),
              "COSStream");
