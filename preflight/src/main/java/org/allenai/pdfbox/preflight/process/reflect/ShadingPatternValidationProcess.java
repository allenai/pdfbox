...
import static org.allenai.pdfbox.preflight.PreflightConfiguration.EXTGSTATE_PROCESS;
...
public class ShadingPatternValidationProcess extends AbstractProcess
{
    ...
    public void validate(PreflightContext context) throws ValidationException
    {
        ...
        {
            context.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_GRAPHIC_MISSING_OBJECT,
            ...
            throws ValidationException
    {
        ...
        {
            context.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_GRAPHIC_INVALID_UNKNOWN_COLOR_SPACE, e.getMessage()));
        }
    }
            ...
            throws ValidationException
    {
        COSDictionary resources = (COSDictionary) shadingRes.getCOSObject().getDictionaryObject(
                PreflightConstants.TRANPARENCY_DICTIONARY_KEY_EXTGSTATE);
        if (resources != null)
        {
