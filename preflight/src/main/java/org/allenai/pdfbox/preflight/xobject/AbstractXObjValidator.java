...
public abstract class AbstractXObjValidator implements XObjectValidator
{
    ...
    protected void checkSMask()
    {
        ...
        if (smask != null
                && !(COSUtils.isString(smask, cosDocument) && PreflightConstants.TRANSPARENCY_DICTIONARY_VALUE_SOFT_MASK_NONE
                        .equals(COSUtils.getAsString(smask, cosDocument))))
        {
            context.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_GRAPHIC_TRANSPARENCY_SMASK,
    ...
    protected void checkOPI()
    {
        ...
        {
            context.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_GRAPHIC_UNEXPECTED_KEY, "Unexpected 'OPI' Key"));
        }
    }
    ...
    protected void checkPostscriptXObject()
    {
        ...
        if (PreflightConstants.XOBJECT_DICTIONARY_VALUE_SUBTYPE_POSTSCRIPT.equals(subtype))
        {
