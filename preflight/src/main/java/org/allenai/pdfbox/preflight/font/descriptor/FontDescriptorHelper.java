...
import org.allenai.pdfbox.preflight.font.util.FontMetaDataValidation;
...
public abstract class FontDescriptorHelper<T extends FontContainer>
{
    ...
    static 
    {
        ...
        MANDATORYFIELDS.add(PreflightConstants.FONT_DICTIONARY_KEY_ITALICANGLE);
        MANDATORYFIELDS.add(PreflightConstants.FONT_DICTIONARY_KEY_CAPHEIGHT);
        MANDATORYFIELDS.add(PreflightConstants.FONT_DICTIONARY_KEY_FONTBBOX);
    ...
    public void validate()
    {
        ...
        {
            this.fContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_DESCRIPTOR_INVALID,
    ...
    protected void checkFontFileMetaData(PDFontDescriptor fontDescriptor, PDStream fontFile)
    {
        try
        {
            ...
            if (metadata != null)
            {
                ...
                {
                    this.fContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_SYNTAX_STREAM_INVALID_FILTER,
                ...
                catch (XmpParsingException e)
                {
                    ...
                    {
                        this.fContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_METADATA_FORMAT_XPACKET,
        ...
        {
            this.fContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_METADATA_FORMAT_UNKOWN,
    ...
    protected final byte[] getMetaDataStreamAsBytes(PDMetadata metadata)
    {
        ...
        {
            this.fContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_METADATA_FORMAT_STREAM,
