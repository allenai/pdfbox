    ...
    public void validate(PreflightContext ctx) throws ValidationException
    {
        ...
        if (catalog != null)
        {
            ...
            if (outlineHierarchy != null)
            {
                ...
                {
                    addValidationError(ctx, new ValidationError(PreflightConstants.ERROR_SYNTAX_TRAILER_OUTLINES_INVALID,
        ...
        {
            ctx.addValidationError(new ValidationError(PreflightConstants.ERROR_SYNTAX_NOCATALOG, "There is no /Catalog entry in the Document"));
        }
    }
