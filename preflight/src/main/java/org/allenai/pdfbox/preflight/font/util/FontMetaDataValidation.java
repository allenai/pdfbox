...
package org.allenai.pdfbox.preflight.font.util;
...
public class FontMetaDataValidation
{
        ...
        if (dc != null && dc.getTitleProperty() != null)
        {
            ...
            if (defaultTitle != null)
            {
                if (!defaultTitle.equals(fontName) && (noSubSetName != null && !defaultTitle.equals(noSubSetName)))
                {
                    ...
                    ve.add(new ValidationResult.ValidationError(PreflightConstants.ERROR_METADATA_MISMATCH, sb.toString()));
                    return false;
                }
            ...
            else
            {
                ...
                if (empty)
                {
                    ...
                    ve.add(new ValidationResult.ValidationError(PreflightConstants.ERROR_METADATA_PROPERTY_MISSING, sb.toString()));
                }
                else
                {
    ...
    public boolean analyseRights(XMPMetadata metadata, PDFontDescriptor fontDesc, List<ValidationResult.ValidationError> ve)
    {
        ...
        if (dc != null)
        {
            ...
            {
                ve.add(new ValidationResult.ValidationError(PreflightConstants.ERROR_METADATA_PROPERTY_MISSING,
