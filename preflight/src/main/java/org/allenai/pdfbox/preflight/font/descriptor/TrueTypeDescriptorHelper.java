...
public class TrueTypeDescriptorHelper extends FontDescriptorHelper<TrueTypeContainer>
{
    ...
    protected void processFontFile(PDFontDescriptor fontDescriptor, PDStream fontFile)
    {
        if (font.isDamaged())
        {
            this.fContainer.push(new ValidationError(PreflightConstants.ERROR_FONTS_TRUETYPE_DAMAGED,
        ...
        else
        {
            ...
            try
            {
                ...
                {
                    this.fContainer.push(new ValidationError(PreflightConstants.ERROR_FONTS_ENCODING,
