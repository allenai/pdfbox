...
package org.allenai.pdfbox.preflight.utils;
...
public final class FilterHelper
{
    ...
    static
    {
        ...
        ALLOWED_FILTERS.add(PreflightConstants.INLINE_DICTIONARY_VALUE_FILTER_RUN);
    }
    ...
    public static void isAuthorizedFilterInPDFA(PreflightContext context, String filter)
    {
        ...
        {
            // --- LZW is forbidden.
            if (PreflightConstants.STREAM_DICTIONARY_VALUE_FILTER_LZW.equals(filter) || PreflightConstants.INLINE_DICTIONARY_VALUE_FILTER_LZW.equals(filter))
            {
                context.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_SYNTAX_STREAM_INVALID_FILTER,
            ...
            {
                context.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_SYNTAX_STREAM_UNDEFINED_FILTER,
