...
public class ActionManagerFactory
{
            ...
            throws ValidationException
    {
        ...
        COSBase oaDict = dictionary.getDictionaryObject(PreflightConstants.DICTIONARY_KEY_OPEN_ACTION);
        ...
        COSBase aa = dictionary.getDictionaryObject(PreflightConstants.DICTIONARY_KEY_ADDITIONAL_ACTION);
        if (aa != null)
        {
            ...
            String additionActionKey, Map<COSObjectKey, Boolean> alreadyCreated) throws ValidationException
    {
        ...
        {
            ctx.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_ACTION_INVALID_TYPE, "Action entry isn't an instance of COSDictionary"));
        }
    }
            ...
            throws ValidationException
    {
        ...
        COSBase nextDict = actionDictionary.getDictionaryObject(PreflightConstants.ACTION_DICTIONARY_KEY_NEXT);
        if (nextDict != null)
        {
            COSDocument cosDocument = ctx.getDocument().getDocument();
            ...
            throws ValidationException
    {
        ...
        if (type != null && !PreflightConstants.ACTION_DICTIONARY_VALUE_TYPE.equals(type))
        {
        ...
        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_GOTO.equals(s))
        {
            return new GoToAction(this, action, ctx, aaKey);
        }

        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_GOTOR.equals(s))
        {
            return new GoToRemoteAction(this, action, ctx, aaKey);
        }

        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_THREAD.equals(s))
        {
            return new ThreadAction(this, action, ctx, aaKey);
        }

        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_URI.equals(s))
        {
            return new UriAction(this, action, ctx, aaKey);
        }

        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_HIDE.equals(s))
        {
            return new HideAction(this, action, ctx, aaKey);
        }

        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_NAMED.equals(s))
        {
            return new NamedAction(this, action, ctx, aaKey);
        }

        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_SUBMIT.equals(s))
        {
            return new SubmitAction(this, action, ctx, aaKey);
        }

        // --- Here is forbidden actions
        if (PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_LAUNCH.equals(s) || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_SOUND.equals(s)
                || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_MOVIE.equals(s) || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_RESET.equals(s)
                || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_IMPORT.equals(s) || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_JAVASCRIPT.equals(s)
                || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_SETSTATE.equals(s) || PreflightConstants.ACTION_DICTIONARY_VALUE_ATYPE_NOOP.equals(s))
        {
