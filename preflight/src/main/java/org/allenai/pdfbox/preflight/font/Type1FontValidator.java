...
import org.allenai.pdfbox.preflight.font.descriptor.Type1DescriptorHelper;
    ...
    protected void checkEncoding()
    {
        ...
        if (encoding != null)
        {
            ...
            if (COSUtils.isString(encoding, cosDocument))
            {
                ...
                if (!(encodingName.equals(PreflightConstants.FONT_DICTIONARY_VALUE_ENCODING_MAC)
                        || encodingName.equals(PreflightConstants.FONT_DICTIONARY_VALUE_ENCODING_MAC_EXP)
                        || encodingName.equals(PreflightConstants.FONT_DICTIONARY_VALUE_ENCODING_WIN)
                        || encodingName.equals(PreflightConstants.FONT_DICTIONARY_VALUE_ENCODING_PDFDOC) || encodingName
                            .equals(PreflightConstants.FONT_DICTIONARY_VALUE_ENCODING_STD)))
                {
                    this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_ENCODING));
                }
            }
