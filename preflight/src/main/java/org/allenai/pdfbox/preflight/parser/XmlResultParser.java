...
public class XmlResultParser
{
    ...
    protected void createResponseWithError(Document rdocument, String pdfType, ValidationResult result, Element preflight)
    {
        ...
        Map<ValidationResult.ValidationError, Integer> cleaned = cleanErrorList(result.getErrorsList());
    ...
    {
        Map<ValidationResult.ValidationError,Integer> cleaned = new HashMap<ValidationResult.ValidationError, Integer>(errors.size());
