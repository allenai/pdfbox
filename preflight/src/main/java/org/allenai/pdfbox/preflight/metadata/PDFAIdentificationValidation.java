...
package org.allenai.pdfbox.preflight.metadata;
...
public class PDFAIdentificationValidation
{
    ...
    public List<ValidationError> validatePDFAIdentifer(XMPMetadata metadata) throws ValidationException
    {
        ...
        if (id == null)
        {
            ve.add(new ValidationError(PreflightConstants.ERROR_METADATA_PDFA_ID_MISSING,
    ...
    protected void checkConformanceLevel(List<ValidationError> ve, String value)
    {
        ...
        {
            ve.add(new ValidationError(PreflightConstants.ERROR_METADATA_INVALID_PDFA_CONFORMANCE));
        }
    }
    ...
    protected void checkPartNumber(List<ValidationError> ve, int value)
    {
        if (value != 1)
        {
            ve.add(new ValidationError(PreflightConstants.ERROR_METADATA_INVALID_PDFA_VERSION_ID));
        }
    }
}
