...
public final class RenderingIntents
{
    ...
    static
    {
        ...
        al.add(PreflightConstants.RENDERING_INTENT_REL_COLOR);
        al.add(PreflightConstants.RENDERING_INTENT_ABS_COLOR);
        al.add(PreflightConstants.RENDERING_INTENT_PERCEPTUAL);
        al.add(PreflightConstants.RENDERING_INTENT_SATURATION);
