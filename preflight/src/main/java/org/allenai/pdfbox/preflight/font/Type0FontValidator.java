...
import org.allenai.fontbox.cmap.CMap;
import org.allenai.fontbox.cmap.CMapParser;
...
public class Type0FontValidator extends FontValidator<Type0Container>
{
    ...
    protected void checkMandatoryFields()
    {
        ...
        if (!areFieldsPResent)
        {
            this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_DICTIONARY_INVALID,
    ...
    protected void processDescendantFont() throws ValidationException
    {
        ...
        if (array == null || array.size() != 1)
        {
             ...
             */
            this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_CIDKEYED_INVALID,
    ...
    protected FontValidator<? extends FontContainer> createDescendantValidator(COSDictionary cidFont)
    {
        ...
        if (PreflightConstants.FONT_DICTIONARY_VALUE_TYPE0.equals(subtype))
        {
            cidFontValidator = createCIDType0FontValidator(cidFont);
        }
        else if (PreflightConstants.FONT_DICTIONARY_VALUE_TYPE2.equals(subtype))
        {
    ...
    protected FontValidator<? extends FontContainer> createCIDType0FontValidator(COSDictionary fDict)
    {
        ...
        {
            this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_CID_DAMAGED,
    ...
    protected void checkCMapEncoding(COSBase encoding)
    {
        if (COSUtils.isString(encoding, cosDocument))
        {
            ...
            if (!(PreflightConstants.FONT_DICTIONARY_VALUE_CMAP_IDENTITY_V.equals(str) || PreflightConstants.FONT_DICTIONARY_VALUE_CMAP_IDENTITY_H
                    .equals(str)))
            {
                this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_CIDKEYED_INVALID,
        ...
        else
        {
            ...
            this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_CIDKEYED_CMAP_INVALID_OR_MISSING,
    ...
    private void processCMapAsStream(COSStream aCMap)
    {
        ...
        try
        {
             ...
             */
            int wmode = aCMap.getInt(COSName.getPDFName(PreflightConstants.FONT_DICTIONARY_KEY_CMAP_WMODE),
                    PreflightConstants.FONT_DICTIONARY_DEFAULT_CMAP_WMODE);
            String type = aCMap.getNameAsString(COSName.TYPE);
            String cmapName = aCMap.getNameAsString(COSName.getPDFName(PreflightConstants.FONT_DICTIONARY_KEY_CMAP_NAME));
            ...
            else if (!PreflightConstants.FONT_DICTIONARY_VALUE_TYPE_CMAP.equals(type))
            {
                this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_CIDKEYED_CMAP_INVALID_OR_MISSING,
                        font.getName() + ": The CMap type is invalid"));
            }
        ...
        {
            this.fontContainer.push(new ValidationResult.ValidationError(PreflightConstants.ERROR_FONTS_CID_CMAP_DAMAGED, font.getName() + ": The CMap type is damaged", e));
        }
        finally
        {
        ...
        COSDictionary cmapUsed = (COSDictionary) aCMap.getDictionaryObject(COSName
                .getPDFName(PreflightConstants.FONT_DICTIONARY_KEY_CMAP_USECMAP));
        if (cmapUsed != null)
        {
