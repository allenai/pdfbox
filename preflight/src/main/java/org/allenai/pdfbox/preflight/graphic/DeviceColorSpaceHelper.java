...
public class DeviceColorSpaceHelper extends StandardColorSpaceHelper
{
    ...
    {
        context.addValidationError(new ValidationError(PreflightConstants.ERROR_GRAPHIC_INVALID_COLOR_SPACE_FORBIDDEN,
    ...
    protected void processIndexedColorSpace(PDColorSpace colorSpace)
    {
        ...
        case I:
        case Pattern:
            context.addValidationError(new ValidationError(PreflightConstants.ERROR_GRAPHIC_INVALID_COLOR_SPACE_FORBIDDEN, colorSpaces
