...
import org.allenai.pdfbox.pdmodel.interactive.annotation.PDAnnotationText;
...
public class TextAnnotationValidator extends AnnotationValidator
{
    ...
    protected boolean checkFlags()
    {
        ...
        if (!result)
        {
            ctx.addValidationError(new ValidationResult.ValidationError(PreflightConstants.ERROR_ANNOT_NOT_RECOMMENDED_FLAG));
        }
        return result;
    }
}
